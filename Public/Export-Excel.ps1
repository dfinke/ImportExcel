...
Update-TypeData -Force -TypeName Array -MemberType ScriptMethod -MemberName ToExcel -Value {
    param(
        [String]$Path,
        [Switch]$Show
    )

    $xlParams = @{ } + $PSBoundParameters

    $xlParams.InputObject = $this
    $xlParams.AutoSize = $true
