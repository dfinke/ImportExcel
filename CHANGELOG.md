...
- Odd behavior on the return of Import-Excel function [#792](https://github.com/dfinke/ImportExcel/issues/792)
- Export-Excel -FreezeTopRow with -Title [#795](https://github.com/dfinke/ImportExcel/issues/795)
- Not importing when first row contains a 0 in a column [#802](https://github.com/dfinke/ImportExcel/issues/802)
...
Thanks, [James O'Neill](https://twitter.com/jamesoneill), for the refactor, and [Illy](https://twitter.com/ili_z) on the continuous integration.
...
Thanks, [James O'Neill](https://twitter.com/jamesoneill), for all the DataTables improvements!

Thanks, [beckerben](https://github.com/beckerben), for the ConvertFromExcelToSQLInsert fix!

Thanks, [Luc Dekens](https://twitter.com/LucD22) for the PipelineVariable issue, and [Ili](https://twitter.com/ili_z) for the PR!

And finally, thanks again to the community for making this module even better.

- [Fix import excel headers](https://github.com/dfinke/ImportExcel/pull/713)
- Numerous improvements for DataTables and exporting it to Excel 
...
- Fix quoting in ConvertFromExcelToSQLInsert
...
Thanks, [uSlackr](https://github.com/uSlackr):

- Fixes Column order issue (plus tests) for `Get-ExcelColumnName`

And thanks, [jhoneill](https://github.com/jhoneill), for the following:
...
- Added [ReadAllSheets.ps1](https://github.com/dfinke/ImportExcel/tree/master/Examples/ReadAllSheets) based on this thread [#678](https://github.com/dfinke/ImportExcel/issues/678)
...
Thanks, [DomRRuggeri](https://github.com/DomRRuggeri), for the Out-Excel PR that kicked off the conversation on `Export-Excel` improvements.

Thanks, [ili101](https://github.com/ili101), for refactoring and improving the defaults and adding the tests for parameters.

- Gave `Export-Excel` sensible defaults, make your life easier and gets things done faster.
...
Thanks, [jhoneill](https://github.com/jhoneill)!
...
Thanks, [James O'Neill](https://github.com/jhoneill), for the optimizations and refactoring leading to a ***~10x*** speed increase, and thanks, [ili101](https://github.com/ili101), for earlier PRs that provided the ground work.
...
Thanks, [James O'Neill](https://github.com/jhoneill), for the great additions.
...
Thanks, Conrad Agramont \([@AGramont](https://twitter.com/@AGramont)\) for the `AddMultiWorkSheet.ps1` example.

Thanks, "Mrs. @Jhoneill", for proof-reading the Help messages.
...
- HotFix for parameter PivotTableStyle should be PivotTableStyle [#453](https://github.com/dfinke/ImportExcel/issues/453)
...
Thanks, (lazywinadmin)[https://github.com/lazywinadmin], for expanding aliases in examples and elsewhere.
...
- Expand aliases in examples and elsewhere.
...
Thanks to [James O'Neill](https://twitter.com/jamesoneill) for contributing the new `Compare-Worksheet` function!
...
# Pre-5.0.0 Release Notes


#### 4/22/2018

A big thank you to the community yet again!
...
Thanks, [Justin Grote](https://github.com/JustinGrote), for fixing the bug in which created Excel files weren't importing to PowerBI online, and [CrashM](https://github.com/CrashM) for testing the fix.
...
Thanks, [James O'Neill](https://twitter.com/jamesoneill), for fixing bugs with `-ChangeDatabase`.
...
Thanks, [jameseholt](https://github.com/jameseholt), for requesting `[Switch]$NoTotalsInPivot`.

* Added switch `[Switch]$NoTotalsInPivot`, which allows the hiding of row totals in the pivot table.
...
Huge thanks to [James O'Neill](https://twitter.com/jamesoneill) for contributing more great additions.
...
Thanks, [ili101](https://github.com/ili101)!
...
Thanks, [Jeremy Brun](https://github.com/jeremytbrun)!
...
Thanks, [robinmalik](https://github.com/robinmalik), for providing us with [the code](https://github.com/dfinke/ImportExcel/issues/174) to implement this new feature, and thanks, [DarkLite1](https://github.com/DarkLite1), for the implementation.
...
Huge thanks to [DarkLite1](https://github.com/DarkLite1)! There is now a new and improved `Import-Excel`, not only in functionality, but also improved readability, examples and more. Not only that, he's been running it in production in his company for a number of weeks!
...
Thanks, [Mikkel Nordberg](https://www.linkedin.com/in/mikkelnordberg), for contributing `ConvertTo-ExcelXlsx`. To use it, Excel needs to be installed. The function converts the older Excel file format ending in `.xls` to the new format ending in `.xlsx`.
...
Thanks, [Damian Reeves](https://twitter.com/DamReev), for all the questions that have led to great features. He asked if it was possible to import an Excel worksheet and transform the data into SQL `INSERT` statements. We can now answer that question with a big YES!

And, a **huge** thank you to [DarkLite1](https://github.com/DarkLite1): Refactoring code, adding help, adding features, and fixing bugs. Particularly, this long outstanding one:
...
Thanks, [DarkLite1](https://github.com/DarkLite1), for more updates.
...
Huge thanks to [DarkLite1](https://github.com/DarkLite1) for some great updates!
...
Thanks, [headsphere](https://github.com/headsphere), for providing backwards compatibility via `$obj.PSObject.Methods[$target]` syntax. (PS v4.0 and later allow `$obj.$target`.)

Thanks, [xelsirko](https://github.com/xelsirko), for fixing the version warning bug.

- [Fixed](https://github.com/dfinke/ImportExcel/pull/126) PowerShell 3.0 compatibility.
- Fixed Import-Excel giving a version warning if started inside background job.
...
Thanks, [Attila Mihalicz](https://github.com/attilamihalicz), for fixing these issues:
...
Huge thanks to [Willie Möller](https://github.com/W1M0R) for the following:

- Added a version check so the PowerShell Classes don't cause issues for down-level version of PowerShell
- Added Pester tests for the module. (They'll be the way tests will be implemented going forward.)
...
Thanks, [Paul Williams](https://github.com/pauldalewilliams), for contributing the following feature.

- Added `-PivotDataToColumn` for transposing data to columns for better charting.
...
```
![](images/PivotAsRows.png)


Now, we just add `-PivotDataToColumn`:
...
That gives us this new chart view:

![](images/PivotAsColumns.png)
...
Thanks, [redoz](https://github.com/redoz), for the following:

- Fixed multi-series charts not working properly.
...
- `Import-Html` using Lee Holmes [Extracting Tables from PowerShell’s Invoke-WebRequest](http://www.leeholmes.com/blog/2015
/01/05/extracting-tables-from-PowerShells-invoke-webrequest/)

![](images/ImportHtml.gif)
...
Thanks, [Boe Prox](https://twitter.com/proxb), for your article entitled [HTML Reporting, Part 2: Take Your Reporting a Step Further](https://mcpmag.com/articles/2016/01/14/html-reporting-part-2.aspx), a great idea that's now part of the ImportExcel module.

- Added `Conditional Text Formatting` (e.g. colorized cells).
...
Thanks, [Johan Åkerström](https://github.com/CosmosKey) \([@neptune443](https://twitter.com/neptune443)\) for the following:

* Added `Get-ExcelSheetInfo`

![](images/GetExcelSheetInfo.png)
...
Huge thanks to [DarkLite1](https://github.com/DarkLite1) for adding the help to Export-Excel.

Big bug fix for version 3.0 PowerShell folks! This technique fails in 3.0 and works in 4.0 and later.
```PowerShell
$m="substring"
"hello".$m(2,1)
```
...
Thanks, [Irwin Strachan](https://github.com/irwins), for the following:
...
Export-Excel can now handle data that is **not** an object
    ...
    echo a b c 1 $true 2.1 1/1/2015
 | Export-Excel c:\temp\test.xlsx -Show
Or
...
Thanks, [Francois Lachance-Guillemette](https://github.com/francoislg), for the following:

* Now import Excel sheets even if the file is open in Excel.
...
Huge thanks to [Justin](https://github.com/zippy1981) for the following:
...
![image](images/FilterFreezeBold.gif)
...
Thanks, [pscookiemonster](https://twitter.com/pscookiemonster), for submitting an important repro case to the EPPlus CodePlex project!
...
![image](images/MultiplePivotTables.png)
...
Thanks, [Irwin Strachan](http://pshirwin.wordpress.com), for this and other great suggestions, testing and more!
